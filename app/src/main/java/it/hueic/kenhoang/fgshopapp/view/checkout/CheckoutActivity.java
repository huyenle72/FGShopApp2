...
import it.hueic.kenhoang.fgshopapp.presenter.checkout.IPresenterCheckout;
...
public class CheckoutActivity extends AppCompatActivity implements
    ...
    PlaceAutocompleteFragment edAddress;
    EditText edPhone, edDesc;
    Button btnCheckout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String address = shippingAddress != null ? shippingAddress.getAddress().toString().trim() : "";
    ...
    private void initView() {
        ...
        edAddress = (PlaceAutocompleteFragment) getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment);
